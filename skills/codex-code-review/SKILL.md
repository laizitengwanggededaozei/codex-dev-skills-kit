...
3. Read project rules and affected code paths.
4. Trace behavior across API, UI, data, permissions, config, and tests.
5. Output findings first, ordered by severity.
6. If no issue is found, say so and list verification gaps.
7. For complex-task reviews, state whether findings affect coding, submission,
